        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">URL Video</th>
        ...
        <div class="p-6">
            <form id="wordForm">
                ...
                <div class="mb-4">
                    ...
                    <p class="mt-1 text-xs text-gray-500">URL gambar kata (bahasa isyarat)</p>
                </div>

                <div class="mb-6">
                    <label for="videoUrl" class="block text-sm font-medium text-gray-700 mb-2">URL Video</label>
