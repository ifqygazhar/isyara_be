...
@section('content')
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        ...
        <button id="addWordBtn"
            class="cursor-pointer w-full md:w-auto px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-200 flex items-center justify-center gap-2">
            ...
            <div class="p-6">
                <form id="wordForm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="kata" required
                    ...
                    <div class="mb-4">
                        ...
                        <div id="urlTab" class="space-y-2">
                            <input type="url" id="imageUrl"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                placeholder="https://example.com/kata-halo.jpg">
                    ...
                    <div class="flex flex-col-reverse sm:flex-row gap-3 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit" id="saveBtn"
                            class="w-full sm:w-auto px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-200 cursor-pointer">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
