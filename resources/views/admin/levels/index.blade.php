        ...
        <div class="p-6">
            <form id="levelForm">
                ...
                <div class="mb-4">
                    ...
                    <input type="url" id="imageUrl" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent" placeholder="https://example.com/gambar-level.jpg">
                    <p class="mt-1 text-xs text-gray-500">
                        <i class="fas fa-image text-gray-400"></i>
                        URL gambar cover untuk level ini
                    </p>
                </div>
                ...
                <div class="flex flex-col-reverse sm:flex-row gap-3 pt-4 border-t border-gray-200">
                    ...
                    <button type="submit" id="saveBtn" class="w-full sm:w-auto px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-200">Simpan Level</button>
                </div>
            </form>
        </div>
    </div>
...
<div id="questionsModal" class="hidden fixed inset-0  bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div class="flex justify-between items-center p-6 border-b border-gray-200 bg-gradient-to-r from-indigo-500 to-purple-600">
            ...
            <button class="close-questions text-white hover:text-gray-200 text-2xl font-light">&times;</button>
        </div>
        <div class="p-6">
...
<!-- Question Form Modal -->
<div id="questionModal" class="hidden fixed inset-0 bg-gray-900 bg-opacity-50 z-[60] flex items-center justify-center p-4">
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        <div class="flex justify-between items-center p-6 border-b border-gray-200">
            <div>
        ...
        <div class="p-6">
            <form id="questionForm">
                ...
                <div class="mb-4">
                    <label for="questionImageUrl" class="block text-sm font-medium text-gray-700 mb-2">
                        URL Gambar Soal *
                    </label>
                    <input type="url" id="questionImageUrl" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent" placeholder="https://example.com/gambar-soal.jpg">
                    <p class="mt-1 text-xs text-gray-500">
                        <i class="fas fa-image text-gray-400"></i>
                        URL gambar bahasa isyarat yang akan ditampilkan sebagai soal
                    </p>
                </div>
                ...
                <div class="flex flex-col-reverse sm:flex-row gap-3 pt-4 border-t border-gray-200">
                    <button type="button" id="cancelQuestionBtn" class="w-full sm:w-auto px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition duration-200">Batal</button>
                    <button type="submit" id="saveQuestionBtn" class="w-full sm:w-auto px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-200">Simpan Pertanyaan</button>
                </div>
            </form>
        </div>
    </div>
