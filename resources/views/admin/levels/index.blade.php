...
@section('content')
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        ...
        <button id="addLevelBtn"
            class="w-full md:w-auto px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-200 flex items-center justify-center gap-2">
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                <p class="text-sm text-blue-700">
                    ...
                    <span class="block">2. Setelah level dibuat, klik tombol <strong class="text-indigo-600">"Kelola
                            Pertanyaan"</strong> untuk menambah soal ke level tersebut</span>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="p-4 border-b border-gray-200">
            <input type="text" id="searchInput" placeholder="Cari level..."
                ...
                <form id="levelForm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="title" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                            placeholder="Contoh: Huruf Dasar A-E">
                    ...
                    <div class="mb-4">
                        ...
                        <div id="urlTab" class="space-y-2">
                            <input type="url" id="imageUrl"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                placeholder="https://example.com/level.jpg">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="description" rows="3" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                            placeholder="Jelaskan materi yang akan dipelajari di level ini..."></textarea>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-yellow-700">
                                    <strong>Catatan:</strong> Setelah level dibuat, Anda bisa menambahkan pertanyaan dengan
                                    klik tombol "Kelola Pertanyaan"
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col-reverse sm:flex-row gap-3 pt-4 border-t border-gray-200">
                        <button type="button" id="cancelBtn"
                            class="w-full sm:w-auto px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition duration-200 cursor-pointer">Batal</button>
                        <button type="submit" id="saveBtn"
                            class="w-full sm:w-auto px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-200 cursor-pointer">Simpan
                            Level</button>
                    </div>
                </form>
            </div>
    ...
    <div id="questionsModal" class="hidden fixed inset-0  bg-opacity-50 z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div
                class="flex justify-between items-center p-6 border-b border-gray-200 bg-gradient-to-r from-indigo-500 to-purple-600">
                <div>
                ...
                <button
                    class="close-questions text-white hover:text-gray-200 text-2xl font-light cursor-pointer">&times;</button>
            </div>
            <div class="p-6">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    ...
                    <button id="addQuestionBtn"
                        class="w-full sm:w-auto px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition duration-200 flex items-center justify-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                        Tambah Pertanyaan
    ...
    <div id="questionModal" class="hidden fixed inset-0  bg-opacity-50 z-[60] flex items-center justify-center p-4">
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div class="flex justify-between items-center p-6 border-b border-gray-200">
                ...
                <button
                    class="close-question text-gray-400 hover:text-gray-600 text-2xl font-light cursor-pointer">&times;</button>
            </div>
            <div class="p-6">
                <form id="questionForm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="questionText" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                            placeholder="Contoh: Apa huruf ini dalam bahasa isyarat?">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <!-- Tab Buttons -->
                        <div class="flex rounded-lg border border-gray-300 mb-3">
                            <button type="button" id="questionUploadTabBtn"
                                class="flex-1 px-4 py-2 text-sm font-medium rounded-l-lg bg-white text-gray-700 hover:bg-gray-50 border-r border-gray-300">
                                <i class="fas fa-upload mr-1"></i> Upload File
                            </button>
                            <button type="button" id="questionUrlTabBtn"
                                class="flex-1 px-4 py-2 text-sm font-medium rounded-r-lg bg-indigo-50 text-indigo-600">
                                <i class="fas fa-link mr-1"></i> URL
                            </button>
                        </div>
                        ...
                        <div id="questionUploadTab" class="hidden space-y-2">
                            ...
                            <div id="questionImagePreview" class="hidden">
                                <img id="questionPreviewImg" src="" alt="Preview"
                                    class="w-full h-48 object-cover rounded-lg border-2 border-gray-300">
                        ...
                        <div id="questionUrlTab" class="space-y-2">
                            <input type="url" id="questionImageUrl"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                placeholder="https://example.com/soal.jpg">
                            <p class="text-xs text-gray-500">
                                <i class="fas fa-info-circle"></i> Masukkan URL lengkap gambar soal
                            </p>
                            <div id="questionUrlImagePreview" class="hidden mt-2">
                                <img id="questionUrlPreviewImg" src="" alt="Preview"
                                    class="w-full h-48 object-cover rounded-lg border-2 border-gray-300">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center gap-2">
                                <input type="radio" name="correctOption" value="A" id="isCorrectA"
                            ...
                            <div class="flex items-center gap-2">
                                <input type="radio" name="correctOption" value="B" id="isCorrectB"
                            ...
                            <div class="flex items-center gap-2">
                                <input type="radio" name="correctOption" value="C" id="isCorrectC"
                                    class="w-4 h-4 text-indigo-600 focus:ring-indigo-500">
                            ...
                            <div class="flex items-center gap-2">
                                <input type="radio" name="correctOption" value="D" id="isCorrectD"
                                    class="w-4 h-4 text-indigo-600 focus:ring-indigo-500">
                        ...
                        <p class="mt-2 text-xs text-gray-500">
                            <i class="fas fa-info-circle text-blue-500"></i>
                            Isi keempat pilihan jawaban dan pilih radio button di sebelahnya untuk menandai jawaban yang
                            benar.
                        </p>
                    </div>
