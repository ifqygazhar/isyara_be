        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nomor Level</th>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Judul</th>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">Pertanyaan</th>
    ...
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="p-6">
            <form id="levelForm">
                ...
                <div class="mb-4">
                    <label for="levelNumber" class="block text-sm font-medium text-gray-700 mb-2">Nomor Level *</label>
                ...
                <div class="mb-6">
                    ...
                    <p class="mt-1 text-xs text-gray-500">contoh: "Huruf Dasar", "Kata Umum", dll.</p>
                </div>
...
<div id="questionsModal" class="hidden fixed inset-0 bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div class="flex justify-between items-center p-6 border-b border-gray-200">
            <h2 id="questionsModalTitle" class="text-xl font-semibold text-gray-900">Kelola Pertanyaan</h2>
            <button class="close-questions text-gray-400 hover:text-gray-600 text-2xl font-light">&times;</button>
        </div>
        <div class="p-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <h3 class="text-lg font-medium text-gray-900">Pertanyaan untuk <span id="levelTitle" class="text-indigo-600"></span></h3>
                <button id="addQuestionBtn" class="w-full sm:w-auto px-3 py-2 bg-indigo-600 text-white text-sm rounded-lg hover:bg-indigo-700 transition duration-200">Tambah Pertanyaan</button>
            </div>
...
<!-- Question Form Modal -->
<div id="questionModal" class="hidden shadow-xl fixed inset-0  bg-opacity-50 z-[60] flex items-center justify-center p-4">
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        <div class="flex justify-between items-center p-6 border-b border-gray-200">
        ...
        <div class="p-6">
            <form id="questionForm">
                ...
                <div class="mb-4">
                    ...
                    <p class="mt-1 text-xs text-gray-500">URL gambar soal (bahasa isyarat)</p>
                </div>
                ...
                <div class="flex flex-col-reverse sm:flex-row gap-3 pt-4 border-t border-gray-200">
                    ...
                    <button type="submit" id="saveQuestionBtn" class="w-full sm:w-auto px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-200">Simpan</button>
                </div>
            </form>
        </div>
    </div>
